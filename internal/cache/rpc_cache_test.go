...
func TestGetKeyFromRequestBody(t *testing.T) {
	cache := NewRPCCache("localhost:8379")
	...
	assert.Equal(t, "eth_getTransactionReceipt:[0x3a6f67beb73d07b1dd10c12de79767b6009f7b351ba1fe6282040aa6c57afef1]", cache.GetKeyFromRequestBody(singleRequestBody))
}
